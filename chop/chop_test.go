...
func TestChop2(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "assert_equal(0,  chop2(1, [1, 3, 5]))",
			args: args{
				num:  1,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(1,  chop2(3, [1, 3, 5]))",
			args: args{
				num:  3,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(2,  chop2(5, [1, 3, 5]))",
			args: args{
				num:  5,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(-1, chop2(0, [1, 3, 5]))",
			args: args{
				num:  0,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(-1, chop2(2, [1, 3, 5]))",
			args: args{
				num:  2,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(-1, chop2(4, [1, 3, 5]))",
			args: args{
				num:  4,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(-1, chop2(6, [1, 3, 5]))",
			args: args{
				num:  6,
				list: []int{1, 3, 5},
			},
		...
		{
			name: "assert_equal(0,  chop2(1, [1, 3, 5, 7]))",
			args: args{
				num:  1,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(1,  chop2(3, [1, 3, 5, 7]))",
			args: args{
				num:  3,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(2,  chop2(5, [1, 3, 5, 7]))",
			args: args{
				num:  5,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(3,  chop2(7, [1, 3, 5, 7]))",
			args: args{
				num:  7,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(-1,  chop2(0, [1, 3, 5, 7]))",
			args: args{
				num:  0,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(-1,  chop2(2, [1, 3, 5, 7]))",
			args: args{
				num:  2,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(-1,  chop2(4, [1, 3, 5, 7]))",
			args: args{
				num:  4,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(-1,  chop2(6, [1, 3, 5, 7]))",
			args: args{
				num:  6,
				list: []int{1, 3, 5, 7},
			},
		...
		{
			name: "assert_equal(-1,  chop2(8, [1, 3, 5, 7]))",
			args: args{
				num:  8,
				list: []int{1, 3, 5, 7},
			},
